...
public class PaymentView extends javax.swing.JFrame {
    ...
    public PaymentView(Long viewId) throws IOException {
        this.viewId = viewId;
    ...
    private void setView() {
        ...
        try {
            payment = pr.getById(viewId);
            System.out.println(payment.getPaymentCode());
            Supplier sup =  new SupplierRepo().getById(payment.getSupplierId());
            ...
            codeField.setText(payment.getPaymentCode());
            dateField.setText(String.valueOf(payment.getPaymentDate()));
            supplierField.setText(payment.getSupplierName());
            supplierCodeField.setText(SupplierCode);
            totalAmiuntField.setValue(payment.getTotalAmount());
            paymentAmountField.setValue(payment.getPaymentAmount());
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            try {
                new PaymentRepo().delete(payment);

                // Delete all items of the report
                PaymentItemRepo pir = new PaymentItemRepo();
                List<PaymentItem> items = pir.getByPaymentId(viewId);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new PaymentView(1L).setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(PaymentView.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
