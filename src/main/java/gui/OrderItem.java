...
public class OrderItem extends JDialog {
    ...
    public OrderItem(java.awt.Frame parent, SelectionListener callback,Supplier supplier) throws IOException {
        ...
        List<ItemSupplier> isList = new ItemSupplierRepo().getBySupplierId(supplier.getId());

        for (ItemSupplier is : isList) {
            Item item = new ItemRepo().getById(is.getItemId());
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(inputPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 388, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        PurchaseOrderItem poi = new PurchaseOrderItem(
                ...
                selectedItem.getId(),
                qty,
                selectedItem.getUnitCost()
        );
        
        if (callback != null) {
            callback.onSelected(poi);
        }
        this.dispose();
